...
- **On-chain commands need an RPC.** Public RPCs are unreliable. Set `RPC_URL_1` or pass `--rpc <url>` to use a private provider (e.g. [Goldsky Edge](https://goldsky.com/products/edge)).
